...
$(DOCDIR)\core_allocator.html : src\core\allocator.d
  $(DMD) -c -d -o- -Isrc -Iimport -Df$@ $(DOCFMT) $**

$(DOCDIR)\core_refcounted.html : src\core\refcounted.d
  $(DMD) -c -d -o- -Isrc -Iimport -Df$@ $(DOCFMT) $**
...
$(IMPDIR)\core\allocator.di : src\core\allocator.d
  $(DMD) -c -d -o- -Isrc -Iimport -Hf$@ $**

$(IMPDIR)\core\refcounted.di : src\core\refcounted.d
  $(DMD) -c -d -o- -Isrc -Iimport -Hf$@ $**

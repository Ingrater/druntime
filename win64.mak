...
$(DRUNTIME_SHARED) : $(OBJS) $(DLLFIXUP) $(SRCS) src\core\sys\windows\dllmain.d win64.mak
	$(DMD) -exportall -of$(DRUNTIME_SHARED_DLL) -version=Shared -shared $(DFLAGS) $(SRCS) src\core\sys\windows\dllmain.d $(OBJS) $(DLLFIXUP) -L/IMPLIB:$(DRUNTIME_SHARED) user32.lib
